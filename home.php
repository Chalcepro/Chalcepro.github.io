                ...
                <div class="row text-start">
                    ...
                    <div class="col col-6 d-flex align-items-center px-5">
                        <div class="container-fluid fontStyle p-4 my-4">
                            ...
                            <p class="fs-5 fontStyle2 text-capitalize" style="color: rgb(248, 217, 159);">This is my official portfolio website to showcase my best works, designs, projects and front-end web designs</p>
                    ...
                    <div class="col d-flex align-items-center justify-content-center imageDesign0">
                        <img src="img/LightBulb.jpg" class="img img-thumbnail border-0 p-0" style="z-index: 1111111;" id="imageDesign1" width="70%" alt="">
                    </div>
                </div>
            </div>
        </div>
